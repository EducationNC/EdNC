																...
																<div class="input">
																	...
																	<div class="switcher-target-hierarchical_logic_entire_<?php echo $ctx->name;?> sub_input">
																		<ul class="tax_hierarchical_logic no-margin">
																			<?php $txes_count = 0; if ( ! empty($post['tax_hierarchical_xpath'][$ctx->name])): foreach ($post['tax_hierarchical_xpath'][$ctx->name] as $path) : if (empty($path)) continue; ?>
																				<li class="dragging">
																		...
																		<a href="javascript:void(0);" class="icon-item add-new-cat"><?php _e('Add Another','pmxi_plugin');?></a>																		
																	</div>
																</div>
																<div class="input">

		...
		try {			
			if (empty($xml)){
				...
				foreach ($post['tax_logic'] as $ctx => $logic) {
					if ( $logic == 'hierarchical' and ! empty($post['tax_hierarchical_logic'][$ctx]) and "entire" == $post['tax_hierarchical_logic'][$ctx] and is_array($post['tax_hierarchical_xpath'][$ctx])){
